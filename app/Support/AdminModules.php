...
class AdminModules
{
    ...
    public const MODULES = [
        ...
        'investors' => ['Investors', [self::VIEW, self::CREATE, self::EDIT, self::DELETE]],
        'investments' => ['Investments', [self::VIEW, self::CREATE, self::EDIT, self::DELETE]],
        'withdrawals' => ['Withdrawals', [self::VIEW, self::CREATE, self::EDIT, self::DELETE]],
        ...
        'blocks' => ['Storefront Blocks', [self::VIEW, self::CREATE, self::EDIT, self::DELETE]],
        'coupons' => ['Coupons', [self::VIEW, self::CREATE, self::EDIT, self::DELETE]],
