    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="hero_title[value_en]" class="form-control" value="{{ \App\Models\Setting::get('hero_title', '', 'en') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="hero_title[value_bn]" class="form-control" value="{{ \App\Models\Setting::get('hero_title', '', 'bn') }}">
            </div>

            <div class="col-md-6">
                <label class="form-label">Hero Description (English)</label>
                <textarea name="hero_desc[value_en]" class="form-control" rows="2">{{ \App\Models\Setting::get('hero_desc', '', 'en') }}</textarea>
                <input type="hidden" name="hero_desc[type]" value="textarea">
            </div>
            <div class="col-md-6">
                <label class="form-label">Hero Description (Bengali)</label>
                <textarea name="hero_desc[value_bn]" class="form-control" rows="2">{{ \App\Models\Setting::get('hero_desc', '', 'bn') }}</textarea>
            </div>
