...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 admin-toolbar admin-toolbar--flush">
        ...
        @include('admin.partials.search', ['route' => route('admin.withdrawals.index'), 'placeholder' => 'Investor or note'])
            ...
            <table class="table table-hover align-middle admin-table">
                <thead>
                    <tr>
                        ...
                        @include('admin.partials.sort', ['key' => 'withdrawn_at', 'label' => 'Date'])
                        @include('admin.partials.sort', ['key' => 'investor', 'label' => 'Investor', 'first' => 'asc'])
                        @include('admin.partials.sort', ['key' => 'account', 'label' => 'Paid from', 'first' => 'asc'])
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="admin-table__empty">No withdrawals recorded yet.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="card-footer bg-white admin-pager">{{ $withdrawals->links() }}</div>
    @endif
</div>
@endsection
